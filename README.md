...
7. installing package: repoze.lru (provides an in-memory memoizing function decorator) by issuing the command: **conda install repoze.lru**, at the command prompt (accept whatever package updates it proposes)
